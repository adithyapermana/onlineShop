...
<body style="background: linear-gradient(135deg, #FFB6C1, #FFCC99); color: #333;" class="d-flex flex-column min-vh-100">
  <div class="container my-5">
    <h1 class="mb-4 text-center text-white">Register</h1>
    <form action="" method="post" class="needs-validation border p-4 rounded shadow-lg bg-white" novalidate>
      <div class="mb-3">
